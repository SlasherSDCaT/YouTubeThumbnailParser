...
const (
	ThumbnailService_GetThumbnail_FullMethodName = "/youtube.ThumbnailService/GetThumbnail"
	ThumbnailService_HealthCheck_FullMethodName  = "/youtube.ThumbnailService/HealthCheck"
)
...
func (c *thumbnailServiceClient) HealthCheck(ctx context.Context, in *HealthRequest, opts ...grpc.CallOption) (*HealthResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HealthResponse)
	err := c.cc.Invoke(ctx, ThumbnailService_HealthCheck_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedThumbnailServiceServer) HealthCheck(context.Context, *HealthRequest) (*HealthResponse, error) {
...
func _ThumbnailService_HealthCheck_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HealthRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ThumbnailServiceServer).HealthCheck(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ThumbnailService_HealthCheck_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ThumbnailServiceServer).HealthCheck(ctx, req.(*HealthRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ThumbnailService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "youtube.ThumbnailService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ThumbnailService_HealthCheck_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "internal/proto/thumbnail.proto",
}
